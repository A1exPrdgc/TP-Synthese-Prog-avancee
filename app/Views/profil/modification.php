...
<div class="auth-container compte-card">
                ...
                <div class="photo-input-group">
                    ...
                    <?php 
                        echo form_label('Changer la photo', 'photo', [
                            'class' => 'profil-btn profil-btn-primary btn-photo'
                        ]); 
                    ?>
    ...
    <div class="compte-buttons-row">
        <a href="<?= site_url('profil'); ?>" class="profil-btn profil-btn-secondary">
            Annuler
        </a>
        
        <?php echo form_submit('submit', 'Enregistrer', ['class' => 'profil-btn profil-btn-primary']); ?>
    </div>
